...
├── tensorag.py             # Produktionsbereite, schlanke Implementierung der ML-GSVD-Klasse
...
Wenn Sie diesen Code oder den Algorithmus in Ihrer Forschung oder kommerziellen Anwendungen nutzen, zitieren Sie bitte die zugrundeliegenden akademischen Originalarbeiten, die dieses Projekt erst möglich gemacht haben:
...
## ⚖️ Lizenz & DSGVO-Konformität

### Lizenz
Dieses Projekt ist unter der **Apache-Lizenz, Version 2.0** lizenziert. Sie dürfen den Code im Rahmen der Lizenzbedingungen frei kopieren, verändern, verbreiten und nutzen (auch für kommerzielle Zwecke). Details finden Sie in der Datei [LICENSE](LICENSE).
